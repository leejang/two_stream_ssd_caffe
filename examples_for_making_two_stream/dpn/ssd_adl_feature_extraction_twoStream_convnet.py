...
model_dir = wk_dir + '/models/adl/SSD_twoStream_convnet_500x500'
...
model_weights = model_dir + '/adl_SSD_twoStream_convnet_500x500_iter_50000.caffemodel'
...
h5_root_path = os.path.join(root_path, 'hdf5s_twoStream_convnet_ssd_%ds' % (future,))
