...
def parse_pred_file(fd, fpath, ix2label):
    val_dict = {}
    gt_dict = {}
...
if __name__ == '__main__':
    ...
    labels = get_labelname(labelmap, range(15))
    ix2label = {}
    print labels
    ...
    for fd in test_sets:
        ...
        val_dict, gt_dict = parse_pred_file(fd, pr_txt, ix2label)
