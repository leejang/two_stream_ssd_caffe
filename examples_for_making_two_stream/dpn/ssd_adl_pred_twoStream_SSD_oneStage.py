...
if __name__ == '__main__':
    ...
    test_result_dir = wk_root + '/results/adl/test_twoStream_oneStage_%ds' % (future,)
    ...
    model_def = model_root + '/adl/SSD_twoStream_oneStage_%ds_500x500/deploy.prototxt' % (future,)
    model_weights = model_root + '/adl/SSD_twoStream_oneStage_%ds_500x500/adl_SSD_twoStream_oneStage_%ds_500x500_iter_%d.caffemodel' % (future,future,max_iter)
