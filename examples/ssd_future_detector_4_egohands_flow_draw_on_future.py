...
file_path = "/data/leejang/recorded_videos_on_0920_2016/scenario2/0210/frame_*.jpg"
target_dir = "/data/leejang/recorded_videos_on_0920_2016/scenario2/0210"
img_sv_path = "/home/leejang/data/exp_new/0210"
...
for test_img in sorted(glob.glob(file_path), key=key_func):
    ...
    if not base_name.isdigit():
        ...
        #future_img = target_dir + "/frame_" +  str(img_cnt + 21) + '.jpg'
        #print future_img
        ...
        ###############################################
        # save output imag
        sv_img = img_sv_path + "/result_gray" + base_name + '.jpg'
        #sv_img = img_sv_path + "/result_future" + base_name + '.jpg'
