...
labelmap_file = 'data/gestures_4_hri/labelmap_voc.prototxt'
...
# main loop
for test_img in sorted(glob.glob("/home/leejang/data/hri_raw/n_p3_s2_1/*.jpg"), key=key_func):
    ...
    # write image
    sv_image = "/home/leejang/data/hri_raw/n_p3_s2_1/result/n_p3_s2_1_%04d.jpg" % (int_cnt)
