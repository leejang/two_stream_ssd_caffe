...
labelmap_file = 'data/egofingers/labelmap_voc.prototxt'
...
model_def = '/home/leejang/lib/ssd_caffe/caffe/models/VGGNet/egofingers/SSD_500x500/deploy.prototxt'
model_weights = '/home/leejang/lib/ssd_caffe/caffe/models/VGGNet/egofingers/SSD_500x500/egofingers_SSD_500x500_iter_30000.caffemodel'
...
int_cnt = 1
for test_img in sorted(glob.glob("/home/leejang/data/piano/Untitled-1080-rotated/*.jpg"), key=key_func):
    ...
    colors = {'right_thumb': (255,0,0), 'right_index': (0,255,0), 'right_middle': (0,0,255), 
              'right_ring': (255,255,0), 'right_baby': (255,102,0),
              'left_thumb': (102,0,204), 'left_index': (204,102,0), 'left_middle': (255,102,204),
              'left_ring': (0,255,255), 'left_baby': (255,0,255), 'false_detection': (0, 0, 0)}
    ...
    # write image
    sv_image = '/home/leejang/data/piano/Untitled-1080-rotated/finger_detection_result/'+'result_'+str(file_name)
